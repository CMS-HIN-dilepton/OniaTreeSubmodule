...
options.outputFile = 'Oniatree_PbPbEW2026_HighPtMuons.root'
...
process.onia2MuMuPatGlbGlb.lowerPuritySelection  = cms.string("pt > 10. && abs(eta) < 2.41 && isGlobalMuon")
...
if applyEventSel:
  ...
  # Muon filtering
  SuperLooseMuonCut = "isGlobalMuon && pt > 10.0 && abs(eta) < 2.41"
